...
## исходный код для создания данных, используемых в книге; он не готов для публичного использования и
## практически не требуется для выполнения примеров из книги
## Данные для книги можно скачать при помощи сценария download_data.t

#################################################################################################
## Создать данные о штатах  

state_pop <- read.csv("/Users/labor/r_projects/statistics-for-data-scientists/data/state_populations.csv")
...
write.csv(state, file="/Users/labor/r_projects/statistics-for-data-scientists/data/state.csv", row.names = FALSE)



#################################################################################################
## Создать данные об авиалиниях
...
#################################################################################################
## Подготовка данных о налоговой стоимости жилой недвижимости
...
#################################################################################################
## Подготовка данных о продаже жилой недвижимости
...
# Импортировать данные о продажах
...
# экспортировать данные о продаже жилой недвижимости
write.table(sales0, file='/Users/andrewbruce1/book/house_sales.csv', sep='\t')


#################################################################################################
## Подготовить данные о ссудах

library(FNN)


## Создать данные о ссудах
...
# Создать признак для ссудозаявителей
...
## Создать данные loan200 для примера KNN
seed <- 10101
